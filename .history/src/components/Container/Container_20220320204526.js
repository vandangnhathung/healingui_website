...
const Container = () => {
  ...
  const ImageContainerLine = styled.img`
    max-width: 407px;
    width: 100%;
    align-self: flex-end;
    ${media.mobile} {
  ...
  `;
  const TextContainerLine = styled.p`
    max-width: 407px;
    width: 100%;
    align-self: flex-end;
    color: #fff;
  ...
  return (
    <StyledContainer>
        ...
        <div className="max-w-[1300px] mx-auto ">
          ...
          <div className="flex flex-col  mr-[70px] mt-[68px] w-full">
            <ImageContainerLine
              src={containerLine}
              alt=""
              className=" w-full max-w-[407px] self-end	"
            />
            <TextContainerLine className=" mt-12">
      ...
      <StyledContent>
        <TitleDiv className="flex justify-between items-center	mb-[110px]">
        ...
        <ContentDiv className="">
          <Image3Img src={Image3} alt="" className="mb-14" />
